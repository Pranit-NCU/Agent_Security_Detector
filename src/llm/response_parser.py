...
def parse_model_json(raw_response: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "exploitability": str(parsed.get("exploitability", "unknown")),
        "recommended_fix": str(parsed.get("recommended_fix", "N/A")),
        "false_positive_probability": float(
            parsed.get("false_positive_probability", round(1.0 - confidence, 4))
        ),
    }
